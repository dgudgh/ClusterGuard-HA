...
func LikelyTemporalSamplingSkew(primary, candidate GTIDSet, primaryUUID string, _, _ time.Time) (bool, error) {
	...
	return HasOnlyAdditionsFromSource(primary, candidate, primaryUUID)
}

func HasOnlyAdditionsFromSource(baseline, candidate GTIDSet, sourceUUID string) (bool, error) {
