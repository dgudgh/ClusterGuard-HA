...
install -m 0644 "${repository}/LICENSE" "${root}/docs/LICENSE"
install -m 0644 "${repository}/THIRD-PARTY-NOTICES.md" "${root}/docs/THIRD-PARTY-NOTICES.md"
install -m 0644 "${repository}/docs/licenses/MPL-2.0.txt" "${root}/docs/MPL-2.0.txt"
