...
install -m 0644 "${repository}/LICENSE" "${kit}/LICENSE"
install -m 0644 "${repository}/THIRD-PARTY-NOTICES.md" "${kit}/THIRD-PARTY-NOTICES.md"
install -m 0644 "${repository}/docs/licenses/MPL-2.0.txt" "${kit}/MPL-2.0.txt"
install -m 0644 "${repository}/docs/zh-CN/licensing.md" "${kit}/docs/许可与合规.md"
...
cp "${kit}/LICENSE" "${output}/LICENSE"
cp "${kit}/THIRD-PARTY-NOTICES.md" "${output}/THIRD-PARTY-NOTICES.md"
cp "${kit}/MPL-2.0.txt" "${output}/MPL-2.0.txt"
printf '离线介质：%s\n' "${archive}"
