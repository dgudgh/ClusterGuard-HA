...
const groups = {
  "en-US": [
    ["Start Here", ["index", "product-overview", "product-tour", "architecture", "release-2.2.46", "release-2.2.45", "release-2.2.44", "release-2.2.43", "release-2.2.42", "release-2.2.41", "release-2.2.40", "release-2.2.39", "release-2.1.45"]],
  ...
  "zh-CN": [
    ["开始使用", ["index", "product-overview", "product-tour", "architecture", "release-2.2.46", "release-2.2.45", "release-2.2.44", "release-2.2.43", "release-2.2.42", "release-2.2.41", "release-2.2.40", "release-2.2.39", "release-2.1.45"]],
